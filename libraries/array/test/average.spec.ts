...
describe('array-average', () => {
  ...
  it('should return the median of the values of an array', () => {
    ...
    expect(() => median([1])).toThrowError('The array does not contain enough values to calculate the median.');
  });
  ...
  it('should return the range of the values of an array', () => {
    ...
    expect(() => range([1])).toThrowError('The array does not contain enough values to calculate the range.');
  });
});
