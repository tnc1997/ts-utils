...
- [#146](https://github.com/tnc1997/ts-utils/pull/146) [`f99249b`](https://github.com/tnc1997/ts-utils/commit/f99249b39674350056336a0b30bf5869e9791eb2) Thanks [@tnc1997](https://github.com/tnc1997)! - Added an `@example` block to the JSDoc comment of every exported function, showing a minimal usage snippet with the expected return value.
